...
Assay: `npm run assay` runs the mass/pair check, the circuit/seek/glia check, the play/learn check, the Jev schema check, and the mini-GPT twins (unique layers vs looped W+T on the same tiny corpus).
